...
tb_buff_template = {
	...
	--  die_clear:int	死亡清除
	--  skill_id:int	技能id
	[143] = {id = 143,name = "跳跃",buff_type = 0,value = 0,duration = 1,frequency = 0,recalculation = 0,die_clear = 0,skill_id = 0,},
	[148] = {id = 148,name = "新手保护",buff_type = 0,value = 0,duration = 0,frequency = 0,recalculation = 0,die_clear = 0,skill_id = 0,},
	[149] = {id = 149,name = "死亡保护",buff_type = 0,value = 0,duration = 0,frequency = 0,recalculation = 0,die_clear = 0,skill_id = 0,},
