...
tb_map = {
	...
	[3002] = {id = 3002,parentid = 3002,name = "封魔战场",tele = {},levellimit = 0,type = 4,inst_type = 1,inst_sub_type = 5,is_instance = 0,shadow = 0,count = 0,day_limit = 0,week_limit = 0,enter_mask = 0,inst_id = {},is_cast = 1,is_PK = 1,is_jump = 1,is_ride = 1,is_sit = 1,rebornX = 0,rebornY = 0,situ = 0,},
	[3003] = {id = 3003,parentid = 3003,name = "仙府夺宝",tele = {},levellimit = 0,type = 4,inst_type = 1,inst_sub_type = 0,is_instance = 0,shadow = 0,count = 0,day_limit = 0,week_limit = 0,enter_mask = 0,inst_id = {},is_cast = 1,is_PK = 1,is_jump = 1,is_ride = 1,is_sit = 1,rebornX = 0,rebornY = 0,situ = 0,},
}
