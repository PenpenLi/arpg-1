...
tb_creature_template = {
	...
	[2001] = {id = 2001,name = "蜜蜂",npcflag = 0,monster_type = 0,level = 1,pro = {{1,162},{2,16},{3,5},{4,1},{5,1},{6,3.99999999999999},{7,1},{8,-500},{9,202}},spell = {10001,400,1,10002,1000,1},ainame = "AI_guaiwu",visionradius = 7,actionradius = 20,attack_type = 0,lockfaceto = -1,attack_range = 4,exp = 10,reward_id = {},dialogue = "你还记得大明湖畔的小青么~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[2002] = {id = 2002,name = "野猪",npcflag = 0,monster_type = 0,level = 2,pro = {{1,184},{2,18},{3,6},{4,1},{5,1},{6,3.99999999999999},{7,1},{8,-500},{9,203}},spell = {10001,400,1,10002,1000,1},ainame = "AI_guaiwu",visionradius = 7,actionradius = 20,attack_type = 0,lockfaceto = -1,attack_range = 4,exp = 11,reward_id = {},dialogue = "我想凤凰涅槃，谁知道一不小心……熟了……",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[2003] = {id = 2003,name = "老鹰",npcflag = 0,monster_type = 0,level = 3,pro = {{1,227},{2,21},{3,7},{4,1},{5,1},{6,4.99999999999999},{7,1},{8,-500},{9,204}},spell = {10001,400,1,10002,1000,1},ainame = "AI_guaiwu",visionradius = 7,actionradius = 20,attack_type = 0,lockfaceto = -1,attack_range = 4,exp = 12,reward_id = {},dialogue = "若不是为了将军家的秋香，我才不会到这里当家奴。",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[2004] = {id = 2004,name = "路霸",npcflag = 0,monster_type = 0,level = 4,pro = {{1,396},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,207}},spell = {10001,400,1,10002,1000,1},ainame = "AI_guaiwu",visionradius = 7,actionradius = 20,attack_type = 0,lockfaceto = -1,attack_range = 4,exp = 13,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
}
