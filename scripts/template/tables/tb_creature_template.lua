...
tb_creature_template = {
	...
	[2003] = {id = 2003,name = "老鹰",npcflag = 0,monster_type = 0,level = 3,pro = {{1,227},{2,21},{3,7},{4,1},{5,1},{6,4.99999999999999},{7,1},{8,-500},{9,204}},spell = {{2001,10000,1200,1}},ainame = "AI_guaiwu",visionradius = 7,actionradius = 20,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 12,reward_id = {},dialogue = "若不是为了将军家的秋香，我才不会到这里当家奴。",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[2004] = {id = 2004,name = "路霸",npcflag = 0,monster_type = 0,level = 4,pro = {{1,396},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,207}},spell = {{2001,10000,1200,1}},ainame = "AI_guaiwu",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 13,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[3001] = {id = 3001,name = "梅超风",npcflag = 0,monster_type = 1,level = 10,pro = {{1,3000},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,207}},spell = {{3002,5000,1000,1},{3003,5000,1000,1},{3001,10000,1000,1}},ainame = "AI_meichaofei",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 13,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[3002] = {id = 3002,name = "东方不败",npcflag = 0,monster_type = 1,level = 10,pro = {{1,3000},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,207}},spell = {{3002,5000,1000,1},{3003,5000,1000,1},{3001,10000,1000,1}},ainame = "AI_dongfangbubai",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 13,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
