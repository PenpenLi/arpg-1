...
tb_creature_template = {
	...
	[2010] = {id = 2010,name = "猴子",npcflag = 0,monster_type = 0,level = 2,pro = {{1,184},{2,18},{3,6},{4,1},{5,1},{6,3.99999999999999},{7,1},{8,-500},{9,80}},spell = {{2001,10000,1200,1}},ainame = "AI_trial",visionradius = 7,actionradius = 20,attack_type = 0,lockfaceto = -1,attack_range = 4,exp = 20,reward_id = {},dialogue = "我想凤凰涅槃，谁知道一不小心……熟了……",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[2011] = {id = 2011,name = "路霸",npcflag = 0,monster_type = 0,level = 4,pro = {{1,396},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,80}},spell = {{2001,10000,1200,1}},ainame = "AI_trial",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 40,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[3001] = {id = 3001,name = "梅超风",npcflag = 0,monster_type = 1,level = 10,pro = {{1,3000},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,100}},spell = {{3002,2000,3000,1},{3003,5000,3000,1},{3001,10000,3000,1}},ainame = "AI_vipboss",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 1000,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
	[3002] = {id = 3002,name = "东方不败",npcflag = 0,monster_type = 1,level = 10,pro = {{1,3000},{2,36},{3,14},{4,1},{5,1},{6,9.00000000000001},{7,1},{8,-450},{9,100}},spell = {{3005,2000,3000,1},{3006,5000,3000,1},{3004,10000,3000,1}},ainame = "AI_trialboss",visionradius = 40,actionradius = 40,attack_type = 2,lockfaceto = -1,attack_range = 4,exp = 1000,reward_id = {},dialogue = "如果我做了皇帝，就封你当太子~",money_min = 0,money_max = 0,money_percent = 0,money_num = 0,drop_belong = 3,},
