...
tb_quest = {
	...
	[20104] = {id = 20104,type = 1,belongSet = 0,belongLvRangeId = 0,chapterName = "",chapter = 0,questName = "击杀小怪",level = 1,start = 0,chapterLast = 0,moduleId = 0,targetsPosition = {{10}},targets = {{22,0,5}},popup = 0,rewards = {},nextid = 0,acitveIds = {20105},guide_id = 0,afterAccept = {},afterFinish = {},},
	[20105] = {id = 20105,type = 1,belongSet = 0,belongLvRangeId = 0,chapterName = "",chapter = 0,questName = "打败BOSS",level = 1,start = 0,chapterLast = 0,moduleId = 0,targetsPosition = {},targets = {{50,1001002}},popup = 0,rewards = {{{2001,1},{104,500}}},nextid = 0,acitveIds = {20106},guide_id = 4,afterAccept = {},afterFinish = {},},
	[20106] = {id = 20106,type = 1,belongSet = 0,belongLvRangeId = 0,chapterName = "",chapter = 0,questName = "装备武器",level = 1,start = 0,chapterLast = 0,moduleId = 0,targetsPosition = {{2,102,2}},targets = {{24,1,0}},popup = 2,rewards = {{{104,500}}},nextid = 0,acitveIds = {20107},guide_id = 5,afterAccept = {},afterFinish = {},},
