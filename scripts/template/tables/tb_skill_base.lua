...
tb_skill_base = {
	...
	[1001] = {id = 1001,name = "玄冥神掌",is_initiative = 1,skill_type = 2,skill_slot = 4,type = 2,target_type = 3,pre = 0,is_end = 0,follow = {},time_change = {},singleCD = 1500,groupCD = 1000,self_cd = 15000,group = 0,skill_percent = 10000,uplevel_id = {1001,1001},magic_type = 0,nuqi_change = 0,attack_mast = {2147737657,4261412927,4160749571,63,262112,4286578688,63,4294705152,1,4286578688,3,0,2032},is_fix = 0,isUnitBallistic = 0,condition_skill = 0,lock_type = 1,need_save = 0,},
	[1002] = {id = 1002,name = "龙象般若功",is_initiative = 1,skill_type = 2,skill_slot = 5,type = 2,target_type = 4,pre = 0,is_end = 0,follow = {},time_change = {},singleCD = 2000,groupCD = 1000,self_cd = 20000,group = 0,skill_percent = 10000,uplevel_id = {1002,1002},magic_type = 0,nuqi_change = 0,attack_mast = {4294967295,4294967295,4160618495,3791618015,65027587,62},is_fix = 0,isUnitBallistic = 0,condition_skill = 0,lock_type = 1,need_save = 0,},
	[10001] = {id = 10001,name = "怪物技能1",is_initiative = 1,skill_type = 1,skill_slot = 1,type = 2,target_type = 0,pre = 0,is_end = 0,follow = {},time_change = {},singleCD = 1000,groupCD = 1000,self_cd = 400,group = 0,skill_percent = 10000,uplevel_id = {5,5},magic_type = 0,nuqi_change = 5,attack_mast = {},is_fix = 0,isUnitBallistic = 0,condition_skill = 0,lock_type = 1,need_save = 0,},
	[10002] = {id = 10002,name = "怪物技能2",is_initiative = 1,skill_type = 1,skill_slot = 1,type = 2,target_type = 0,pre = 5,is_end = 0,follow = {},time_change = {},singleCD = 1000,groupCD = 1000,self_cd = 400,group = 0,skill_percent = 10000,uplevel_id = {6,6},magic_type = 0,nuqi_change = 5,attack_mast = {},is_fix = 0,isUnitBallistic = 0,condition_skill = 0,lock_type = 1,need_save = 0,},
}
