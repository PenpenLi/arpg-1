...
PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD = 286	-- 跳跃CD
PLAYER_EXPAND_INT_FCM_LOGIN_TIME = 287	-- 防沉迷，单位：分钟	-1是非防沉迷玩家
PLAYER_EXPAND_INT_FCM_LOGOUT_TIME = 288	-- 防沉迷离线时间
PLAYER_EXPAND_INT_CREATE_TIME = 289	-- 角色创建时间
PLAYER_EXPAND_INT_LAST_LOGIN_TIME = 290	-- 最后登录时间
PLAYER_EXPAND_INT_LAST_LOGOUT_TIME = 291	-- 最后离线时间
PLAYER_EXPAND_INT_NUMBER_OF_LOGINS = 292	-- 累积登录次数
PLAYER_EXPAND_INT_MONEY = 293	-- 各种货币
PLAYER_EXPAND_INT_USE_FASHION = 317	-- 是否启用时装,目前用到20个pos
PLAYER_EXPAND_INT_XP = 318	-- 当前经验，64位
PLAYER_EXPAND_INT_NEXT_LEVEL_XP = 320	-- 下一级经验，64位
PLAYER_EXPAND_INT_MAP_STATUS = 322	-- 地图开启进度
PLAYER_EXPAND_INT_GAG_END_TIME = 323	-- 禁言结束时间
PLAYER_EXPAND_INT_TO_MAP = 324	-- 玩家要传送到的地图
PLAYER_EXPAND_INT_TO_INSTANCE_ID = 325	-- 玩家要传送到的地图实例ID
PLAYER_EXPAND_INT_TO_POS_X = 326	-- 玩家药传送到的坐标
PLAYER_EXPAND_INT_TO_POS_Y = 327
PLAYER_EXPAND_INT_TO_LINE_NO = 328	-- 传送线号
PLAYER_EXPAND_INT_DB_MAP = 329	-- 玩家最后一次进入副本前的地图	
PLAYER_EXPAND_INT_DB_POS_X = 330	-- 玩家最后一次进入副本前的坐标
PLAYER_EXPAND_INT_DB_POS_Y = 331
PLAYER_EXPAND_INT_CLIENT_DATA = 332	-- 远程存储
-- ////////////////////////////////////////////////////////////////////////
-- 应用服部分	
PLAYER_APPD_INT_FIELD_FLAG = 432	-- 玩家标志位
PLAYER_APPD_INT_FIELD_FLAG_END = 439	-- 结束下标
PLAYER_APPD_INT_FIELD_DAILY_TIME = 439	-- 每天在线时长（min）
PLAYER_APPD_INT_FIELD_RESET_DALIY = 440	-- 重置的时间点每小时一次
PLAYER_APPD_INT_FIELD_RECHARGE_SUM = 464	-- 累计充值总数
PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME = 465	-- 最后一笔充值时间
PLAYER_APPD_INT_FLELD_JHM_FLAGS = 466	-- 激活码flags
PLAYER_APPD_INT_FLELD_JHM_FLAGS_END = 474	-- 激活码flags_end
-- 主背包扩展时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME = 475	-- 主包裹扩展结束时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME = 476	-- 主包裹扩展剩余多少时间
...
SOCIAL_FRIEND_END = 106	-- 好友结束
SOCIAL_ENEMY_START = 106	-- 仇人开始
SOCIAL_ENEMY_END = 146	-- 仇人结束
SOCIAL_APPLY_START = 146	-- 申请开始
SOCIAL_APPLY_END = 156	-- 申请结束
SOCIAL_APPLY_CLEAR_FLAG = 157	-- 申请清除标记
SOCIAL_ENEMY_TIME_START = 158	-- 仇人时间戳开始
SOCIAL_ENEMY_TIME_END = 178	-- 仇人时间戳结束
