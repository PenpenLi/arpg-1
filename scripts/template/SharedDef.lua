...
SOCIAL_ICON_VIP_LEV = 0
SOCIAL_FAMILIAR_LEV_EXP = 1
MAX_FRIENT_COUNT = 2
SOCIAL_BASE_COUNT = 0	-- SOCIAL_BASE_COUNT = 0,//好友个数
SOCIAL_FRIEND_START = 0	-- 好友开始
SOCIAL_FRIEND_END = 100	-- 好友结束
SOCIAL_ENEMY_START = 101	-- 仇人开始
SOCIAL_ENEMY_END = 141	-- 仇人结束
SOCIAL_APPLY_START = 142	-- 申请开始
SOCIAL_APPLY_END = 182	-- 申请结束
