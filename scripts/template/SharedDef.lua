...
UINT_INT_FIELD_PASSIVE_SPELL_END = 184	-- 被动技能结束
MAX_UNIT_FIELD = 185
...
PLAYER_INT_FIELD_PASSIVE_SPELL_END = 711	-- 被动技能个数
PLAYER_INT_FIELD_VIRTUAL_CAMP = 711	-- 虚拟阵营
PLAYER_INT_FIELD_WORLD_3V3_SCORE = 712	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE = 713	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO = 714	-- 胜负走势
PLAYER_INT_FIELD_DOUJIANTAI_RANK = 715	-- 斗剑台排名
PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME = 716	-- 最后一次刷新对手时间戳
PLAYER_INT_FIELD_ARREARS = 717	-- 欠费
PLAYER_INT_FIELD_DAILY_QUEST_FINISHED = 719	--  每日任务完成数
PLAYER_INT_FIELD_BAG_SORT_TIME = 720	-- 整理背包时间戳
-- 已开启功能的记录
PLAYER_INT_FIELD_OPEN_MENU_INDEX = 721
PLAYER_INT_FIELD_OPEN_MENU_START = 722
PLAYER_INT_FIELD_OPEN_MENU_END = 822
-- 已购家族商店物品的记录
PLAYER_INT_FIELD_BUYED_FACTION_SHOP = 823	-- 已购家族商店物品开始
PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END = 831	-- 已购家族商店物品结束
-- 记录强制引导ID 
PLAYER_INT_FIELD_GUIDE_ID_LAST = 832	-- 上次完成的引导
PLAYER_INT_FIELD_GUIDE_ID_NOW = 833	-- 当前进行中的引导
-- 修炼场相关
PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME = 834	-- 上次挑战时间戳
PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME = 835	-- 上次刷新对手时间戳
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP = 836	-- 当日累计掠夺经验
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST = 837	-- 当日累计掠夺宝箱数
PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT = 838	-- 当日购买次数
PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT = 839	-- 当前剩余挑战次数
PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX = 840	-- 修练场修炼记录下标
PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT = 841	-- 本轮被掠夺成功次数
PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT = 842	-- 本日总掠夺次数
PLAYER_INT_FIELD_CULTIVATION_START_TIME = 843	-- 修炼开始时间
PLAYER_INT_FIELD_CULTIVATION_LOST_INFO = 844	-- 修炼宝箱丢失信息
-- 登陆大礼相关
PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS = 845	-- 登陆总天数
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START = 846	-- 领取状态开始
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END = 848	-- 领取状态结束
--  非强制引导ID
PLAYER_INT_FIELD_OPTIONAL_GUIDE_START = 849	-- 非强制引导开始
PLAYER_INT_FIELD_OPTIONAL_GUIDE_END = 909	--  非强制引导结束
PLAYER_INT_FILED_LEAVE_RISK_TIME = 909	-- 离开冒险世界的时间戳
PLAYER_INT_FILED_LEAVE_RISK_PICKED = 910	-- 是否已经领取不在冒险世界的挂机奖励
PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT = 911	-- 家族建筑升级加速每日次数
PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT = 912	-- 家族宝库贡献礼物兑换每日次数
PLAYER_INT_FILED_CHARM_POINT = 913	-- 魅力值
PLAYER_INT_FILED_FACTION_GIFT_NEXT_COUNT_ID = 915	-- 玩家礼物历史记录下一个count_id
PLAYER_INT_FILED_FACTION_GIFT_START = 916	-- 玩家礼物历史记录开始
PLAYER_INT_FILED_FACTION_GIFT_END = 1666
PLAYER_INT_FIELD_CREATE_ICON = 1666	-- 待创建的帮派icon
PLAYER_INT_FIELD_FACTION_GIFT_POINT_COUNT = 1667	-- 帮派魅力赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_SEND_COUNT = 1669	-- 帮派礼物赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_BEEN_THANK_COUNT = 1670	-- 帮派礼物赠送被女王感谢记数
PLAYER_INT_FIELD_MASS_BOSS_BUYED_TIMES = 1671	-- 已经购买次数
...
PLAYER_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG = 1676	-- 组队副本首次通关flag
-- ////////////////////////////////////////////////////////////////////////////////////////////////////////
-- 字符串部分
...
MAX_KUAFU_GROUP_INSTANCE_PLAYER_INT_COUNT = 1	--  kuafu属性数量
...
KUAFU_GROUP_INSTANCE_INT_FIELDS_PLAYER_INFO_END = 47
