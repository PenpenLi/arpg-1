...
UINT_FIELD_BOSS_DATA = 96	-- boss数据byte 0:boss状态 1:boss前一状态 2:boss索引(云游的是这个用途)
UINT_FIELD_BOSS_DATA1 = 97	-- boss数据byte 0:当前坐标x 1:当前坐标y 2:下一坐标x 3:下一坐标y(云游的是这个用途)
MAX_UNIT_FIELD = 98
...
MAP_TYPE_MAIN = 0	-- 主城
MAP_TYPE_FIELD = 0	-- 野外
MAP_TYPE_INSTANCE = 0	-- 副本
MAP_TYPE_ACTIVITY = 0	-- 活动
MAP_TYPE_PVP = 0	-- PVP
--  副本人物类型
