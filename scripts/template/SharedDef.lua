...
QUEST_FIELD_QUEST_END = 312	-- 任务结束
QUEST_FIELD_TITLE_START = 312	-- 称号开始
QUEST_FIELD_TITLE_END = 512	-- 称号结束
-- 战斗状态
...
PLAYER_INT_FIELD_MOUNT_LEVEL = 574	-- 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
PLAYER_INT_FIELD_DIVINE_ID = 575	-- 当前装备的神兵id
PLAYER_INT_FIELD_PASSIVE_SPELL_START = 576	-- 被动技能开始
PLAYER_INT_FIELD_PASSIVE_SPELL_END = 626	-- 被动技能个数
-- ////////////////////////////////////////////////////////////////////////////////////////////////////////
-- 字符串部分
...
MAP_INT_FIELD_QUEST_END_TM = 38	-- 副本任务结束时间
MAP_INT_FIELD_END_TM = 39	-- 副本结束时间
MAP_INT_FIELD_INSTANCE_TYPE = 40	-- 副本类型
-- 地图字符串部分
...
WORLDBOSS_FIELDS_BORN_TIME = 42	-- 刷新等待时间戳
-- 试炼塔
TRIAL_INSTANCE_FIELD_ID = 41	--  当前层数
--  桃花迷阵最大刷新次数
TAOHUA_REFRESH_TIMES = 10
-- 桃花迷阵地图数据
TAOHUA_INT_FIELD_REFRESH_TIMES = 41	-- 桃花迷阵已经刷新次数
TAOHUA_INT_FIELD_BOSS_CURR_HP = 42	-- BOSS当前血量
TAOHUA_STR_FIELD_REAL_BOSS_GUID = 5	-- BOSS真身GUID
-- 塔的最大层数
TOWER_MAX_FLOOR = 2
-- 塔怪每层击杀数量
TAGUAI_INT_FIELD_FIRST_FLOOR = 41	-- 第一层的信息
-- 战斗信息整形字符型枚举
-- 貌似没必要,随便留一个吧
