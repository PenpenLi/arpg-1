...
QUEST_CHANGED = 1	-- 变化
QUEST_NEW = 2
ACHIEVE_TYPE_LEVEL = 1	-- 等级达到x
ACHIEVE_TYPE_MOUNT = 2	-- 坐骑达到x
ACHIEVE_TYPE_KILL_MONSTER = 3	-- 击杀怪物x
ACHIEVE_TYPE_FRIEND = 4	-- 拥有好友x
ACHIEVE_TYPE_DIVINE_NUM = 5	-- 拥有神兵x
ACHIEVE_TYPE_DIVINE_LEV = 6	-- 神兵等级x
ACHIEVE_TYPE_DOUJIANTAI = 7	-- 斗剑台胜利x
