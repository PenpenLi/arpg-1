...
GLOBALVALUE_STRING_FIELD_DOUJIANTAI_START = 95	--  斗剑台排名开始
GLOBALVALUE_STRING_FIELD_DOUJIANTAI_END = 1095	--  斗剑台排名结束
-- 计时器世界变量计数器
...
KUAFU_XIANFU_PLAYER_MONEY = 1	--  元宝数据
KUAFU_XIANFU_PLAYER_MONEY_CHANGED = 3	--  元宝改变值
KUAFU_XIANFU_PLAYER_SETTLEMENT = 5	--  玩家战力
MAX_KUAFU_XIANFU_INT_COUNT = 6	--  kuafu属性数量
...
KUAFU_XIANFU_FIELDS_INT_INFO_END = 102	--  3v3总共6个人
KUAFU_XIANFU_FIELDS_INT_BOSS_INDX = 102	-- 当前的bossid
KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_START = 103	-- BOSS信息开始
KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_END = 118
KUAFU_XIANFU_FIELDS_HARD = 118	-- 副本难度
