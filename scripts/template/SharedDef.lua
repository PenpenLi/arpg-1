...
PLAYER_EXPAND_INT_USE_FASHION = 346	-- 是否启用时装,目前用到20个pos
PLAYER_EXPAND_INT_XP = 347	-- 当前经验，64位
PLAYER_EXPAND_INT_NEXT_LEVEL_XP = 349	-- 下一级经验，64位
PLAYER_EXPAND_INT_MAP_STATUS = 351	-- 地图开启进度
PLAYER_EXPAND_INT_GAG_END_TIME = 352	-- 禁言结束时间
PLAYER_EXPAND_INT_TO_MAP = 353	-- 玩家要传送到的地图
PLAYER_EXPAND_INT_TO_INSTANCE_ID = 354	-- 玩家要传送到的地图实例ID
PLAYER_EXPAND_INT_TO_POS_X = 355	-- 玩家药传送到的坐标
PLAYER_EXPAND_INT_TO_POS_Y = 356
PLAYER_EXPAND_INT_TO_LINE_NO = 357	-- 传送线号
PLAYER_EXPAND_INT_DB_MAP = 358	-- 玩家最后一次进入副本前的地图	
PLAYER_EXPAND_INT_DB_POS_X = 359	-- 玩家最后一次进入副本前的坐标
PLAYER_EXPAND_INT_DB_POS_Y = 360
PLAYER_EXPAND_INT_CLIENT_DATA = 361	-- 远程存储
-- ////////////////////////////////////////////////////////////////////////
-- 应用服部分	
PLAYER_APPD_INT_FIELD_FLAG = 461	-- 玩家标志位
PLAYER_APPD_INT_FIELD_FLAG_END = 468	-- 结束下标
PLAYER_APPD_INT_FIELD_DAILY_TIME = 468	-- 每天在线时长（min）
PLAYER_APPD_INT_FIELD_RESET_DALIY = 469	-- 重置的时间点每小时一次
PLAYER_APPD_INT_FIELD_RECHARGE_SUM = 493	-- 累计充值总数
PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME = 494	-- 最后一笔充值时间
PLAYER_APPD_INT_FLELD_JHM_FLAGS = 495	-- 激活码flags
PLAYER_APPD_INT_FLELD_JHM_FLAGS_END = 503	-- 激活码flags_end
-- 主背包扩展时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME = 504	-- 主包裹扩展结束时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME = 505	-- 主包裹扩展剩余多少时间
PLAYER_INT_FIELD_BLOCK_COUNT = 507	-- 屏蔽列表个数
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID = 508	-- 最后一次参加的世界BOSS id
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE = 509	-- 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
-- 场景服扩展下标开始了
PLAYER_SCENED_INT_FLAGS = 510	-- 玩家场景服标志位
--  只显示装备的主动技能
PLAYER_INT_FIELD_SPELL_START = 518
PLAYER_INT_FIELD_SPELL_END = 530
-- 重要技能的CD
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START = 530
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END = 570
PLAYER_EXPAND_KILL_MONSTER = 570	-- 杀怪数
-- 跨服
PLAYER_APPD_INT_FIELD_KUAFU_WARID = 571	-- 跨服场次id
PLAYER_INT_FIELD_KUAFU_NUMBER = 572	-- 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
PLAYER_INT_FIELD_MAIN_QUEST_ID = 573	-- 当前主线任务
PLAYER_INT_FIELD_QUEST_CHAPTER = 574	-- 任务章节奖励领取情况
PLAYER_INT_FIELD_MOUNT_LEVEL = 575	-- 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
...
PLAYER_INT_FIELD_WORLD_3V3_SCORE = 628	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE = 629	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO = 630	-- 胜负走势
-- ////////////////////////////////////////////////////////////////////////////////////////////////////////
-- 字符串部分
...
KUAFU_3V3_FIELDS_INT_LAST_KILL = 72	--  最近一次击杀信息, 2个short (0:击杀者下标, 1:被杀者下标)
