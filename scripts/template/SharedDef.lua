...
MAX_FACTION_STOREHOUSE_RECORD_COUNT = 20
-- 帮派下标
-- UINT32 部分
FACTION_INT_FIELD_PLAYER_NOW_INDEX = 0	-- 帮派成员空位置索引
FACTION_INT_FIELD_FLAG = 1	-- 帮派FLAG
FACTION_INT_FIELD_PLAYER = 2	-- 帮派成员开始下标
FACTION_INT_FIELD_PLAYER_END = 352	-- 帮派申请索引
FACTION_INT_FIELD_APPLY_PLAYER_COUNT_INDEX = 352
FACTION_INT_FIELD_APPLY_PLAYER = 353	-- 玩家申请加入帮派列表
FACTION_INT_FIELD_APPLY_PLAYER_END = 374	-- 帮派申请玩家列表
FACTION_INT_FIELD_EVENT = 374	-- 帮派记录开始
FACTION_INT_FIELD_EVENT_END = 394	-- 帮派记录结束
FACTION_INT_FIELD_EVENT_FALG = 394	-- 帮派记录标志位
FACTION_INT_FIELD_SHOP = 395	-- 商店开始
FACTION_INT_FIELD_SHOP_END = 403	-- 商店结束
FACTION_INT_FIELD_FORCE = 403	-- 帮派战斗力
FACTION_INT_FIELD_MONEY = 405	-- 帮派资产
FACTION_INT_FIELD_LEVEL = 407	-- 帮派等级
FACTION_INT_FIELD_ACTIVITY = 408	-- 帮派活跃度
FACTION_INT_FIELD_RANK = 409	-- 帮派排名
FACTION_INT_FIELD_FLAGS_ID = 410	-- (byte)0:帮派当前选择的旗帜ID (byte)1:神明等级 (uint16)1:灵气
FACTION_INT_FIELD_MINLEV = 411	-- 加入帮派最小等级
FACTION_INT_FIELD_TOKEN_NUM = 412	-- 令牌数量
FACTION_INT_FIELD_TOKEN_POINTS = 413	-- 令牌今日积分进度
FACTION_INT_FIELD_TOKEN_POINTS_COUNT = 414	-- 令牌今日积分完成次数
FACTION_INT_FIELD_TOKEN_TODAY_BUY_COUNT = 415	-- 今日令牌购买次数
FACTION_INT_FIELD_CHALLENGE_BOSS_ID_MAX = 416	-- 已挑战最大boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_ID = 417	-- 当前挑战boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_START_TIME = 418	-- 当前挑战开始时间
FACTION_INT_FIELD_CHALLENGE_BOSS_HP_RATE = 419	-- 当前boss血量万分比
FACTION_INT_FIELD_CHALLENGE_BOSS_POS = 420	-- 当前boss位置 x,y
FACTION_INT_FIELD_PROTECT_TARGET_HP_RATE = 421	-- 当前守护目标血量万分比
FACTION_INT_FIELD_PROTECT_TARGET_POS = 422	-- 当前守护目标位置 x,y
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_START = 423	-- 当前boss输出榜开始 int 输出值
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_END = 473	-- 当前boss输出榜结束
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_START = 473	-- 总输出榜开始
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_END = 523	-- 总输出榜结束
FACTION_INT_FIELD_STOREHOUSE_ITEM_COUNT = 523	-- 宝库道具数量
FACTION_INT_FIELD_STOREHOUSE_RECORD_CURSOR = 524	-- 宝库记录游标
FACTION_INT_FIELD_BUILDING_ID_START = 525	-- 已有建筑id开始
FACTION_INT_FIELD_BUILDING_ID_END = 535	-- 已有建筑id结束
FACTION_INT_FIELD_BUILDING_LVUP_ID = 535	-- 当前正在升级的建筑id
FACTION_INT_FIELD_BUILDING_LVUP_FINISH_TIME = 536	-- 当前升级建筑完成时间戳
...
FACTION_STRING_FIELD_STOREHOUSE_RECORD_END = 344	-- 宝库记录结束
