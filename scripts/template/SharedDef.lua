...
FACTION_MANAGER_TYPE_NO_REVIEW = 4	-- 勾选“不需审核”
...
-- 帮派申请列表最大玩家数
MAX_FACTION_APLLY_MAMBER_COUNT = 18
-- 帮派最大成员数
MAX_FACTION_MAMBER_COUNT = 18
-- 帮派最大红包数
...
FACTION_INT_MEMBER_TOTAL_CONTRIBUTION = 6	-- 历史贡献
...
FACTION_INT_FIELD_PLAYER_END = 128	-- 帮派申请索引
FACTION_INT_FIELD_APPLY_PLAYER_COUNT_INDEX = 128
FACTION_INT_FIELD_APPLY_PLAYER = 129	-- 玩家申请加入帮派列表
FACTION_INT_FIELD_APPLY_PLAYER_END = 255	-- 帮派申请玩家列表
FACTION_INT_FIELD_FORCE = 255	-- 帮派战斗力
FACTION_INT_FIELD_MONEY = 257	-- 帮派资产
FACTION_INT_FIELD_LEVEL = 259	-- 帮派等级
FACTION_INT_FIELD_ACTIVITY = 260	-- 帮派活跃度
FACTION_INT_FIELD_RANK = 261	-- 帮派排名
FACTION_INT_FIELD_FLAGS_ID = 262	-- (byte)0:帮派当前选择的旗帜ID (byte)1:神明等级 (uint16)1:灵气
FACTION_INT_FIELD_MINLEV = 263	-- 加入帮派最小等级
FACTION_STRING_FIELD_PLAYER = 4	-- 帮派成员列表		
FACTION_STRING_FIELD_PLAYER_END = 40	-- 帮派成员列表结束
FACTION_STRING_FIELD_APPLY_PLAYER = 40	-- 帮派申请玩家列表
FACTION_STRING_FIELD_APPLY_PLAYER_END = 76	-- 帮派申请玩家列表结束
FACTION_STRING_FIELD_GONGGAO = 76	-- 帮派公告
FACTION_STRING_FIELD_ZHAOMU_GONGGAO = 77	-- 招募公告
