...
BUFF_TYPE_NONE = 0	-- 无
BUFF_TYPE_ATTR_START = 1	-- 属性开始
BUFF_TYPE_ATTR_END = 30	-- 属性结束
BUFF_TYPE_ADD_HP_PER_RATE = 31	-- 周期性回血百分比
...
UINT_INT_FIELD_PASSIVE_SPELL_START = 121	-- 被动技能开始
UINT_INT_FIELD_PASSIVE_SPELL_END = 171	-- 被动技能结束
MAX_UNIT_FIELD = 172
