...
PLAYER_STRING_FILED_FACTION_GIFT_START = 90	-- 玩家礼物历史记录开始
PLAYER_STRING_FILED_FACTION_GIFT_END = 690
...
FACTION_INT_MEMBER_TOTAL_SEND_CHARM = 7	-- 魅力总贡献
MAX_FACTION_INT_MEMBER = 8
-- 帮派成员的STRING信息
...
FACTION_INT_FIELD_PLAYER_END = 402	-- 帮派申请索引
FACTION_INT_FIELD_APPLY_PLAYER_COUNT_INDEX = 402
FACTION_INT_FIELD_APPLY_PLAYER = 403	-- 玩家申请加入帮派列表
FACTION_INT_FIELD_APPLY_PLAYER_END = 427	-- 帮派申请玩家列表
FACTION_INT_FIELD_EVENT = 427	-- 帮派记录开始
FACTION_INT_FIELD_EVENT_END = 447	-- 帮派记录结束
FACTION_INT_FIELD_EVENT_FALG = 447	-- 帮派记录标志位
FACTION_INT_FIELD_SHOP = 448	-- 商店开始
FACTION_INT_FIELD_SHOP_END = 456	-- 商店结束
FACTION_INT_FIELD_FORCE = 456	-- 帮派战斗力
FACTION_INT_FIELD_MONEY = 458	-- 帮派资产
FACTION_INT_FIELD_LEVEL = 460	-- 帮派等级
FACTION_INT_FIELD_ACTIVITY = 461	-- 帮派活跃度
FACTION_INT_FIELD_RANK = 462	-- 帮派排名
FACTION_INT_FIELD_FLAGS_ID = 463	-- (byte)0:帮派当前选择的旗帜ID (byte)1:神明等级 (uint16)1:灵气
FACTION_INT_FIELD_MINLEV = 464	-- 加入帮派最小等级
FACTION_INT_FIELD_TOKEN_NUM = 465	-- 令牌数量
FACTION_INT_FIELD_TOKEN_POINTS = 466	-- 令牌今日积分进度
FACTION_INT_FIELD_TOKEN_POINTS_COUNT = 467	-- 令牌今日积分完成次数
FACTION_INT_FIELD_TOKEN_TODAY_BUY_COUNT = 468	-- 今日令牌购买次数
FACTION_INT_FIELD_CHALLENGE_BOSS_ID_MAX = 469	-- 已挑战最大boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_ID = 470	-- 当前挑战boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_START_TIME = 471	-- 当前挑战开始时间
FACTION_INT_FIELD_CHALLENGE_BOSS_HP_RATE = 472	-- 当前boss血量万分比
FACTION_INT_FIELD_CHALLENGE_BOSS_POS = 473	-- 当前boss位置 x,y
FACTION_INT_FIELD_PROTECT_TARGET_HP_RATE = 474	-- 当前守护目标血量万分比
FACTION_INT_FIELD_PROTECT_TARGET_POS = 475	-- 当前守护目标位置 x,y
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_START = 476	-- 当前boss输出榜开始 int 输出值
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_END = 526	-- 当前boss输出榜结束
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_START = 526	-- 总输出榜开始
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_END = 576	-- 总输出榜结束
FACTION_INT_FIELD_STOREHOUSE_ITEM_COUNT = 576	-- 宝库道具数量
FACTION_INT_FIELD_STOREHOUSE_RECORD_CURSOR = 577	-- 宝库记录游标
FACTION_INT_FIELD_BUILDING_ID_START = 578	-- 已有建筑id开始
FACTION_INT_FIELD_BUILDING_ID_END = 588	-- 已有建筑id结束
FACTION_INT_FIELD_BUILDING_LVUP_ID = 588	-- 当前正在升级的建筑id
FACTION_INT_FIELD_BUILDING_LVUP_FINISH_TIME = 589	-- 当前升级建筑完成时间戳
FACTION_INT_FIELD_IS_DISSOLVED = 590	-- 是否解散
FACTION_INT_FIELD_GIFT_WEEK_POINT_START = 591	-- 礼物周榜魅力值计数开始
FACTION_INT_FIELD_GIFT_WEEK_POINT_END = 641	-- 礼物周榜魅力值计数结束
FACTION_INT_FIELD_GIFT_UNCHECK_COUNT_START = 641	-- 未处理礼物计数开始 女王未感谢 成员为领取
FACTION_INT_FIELD_GIFT_UNCHECK_COUNT_END = 691	-- 未处理礼物计数结束
FACTION_INT_FIELD_CHARM_POINT = 692	-- 帮派女王魅力值 double
FACTION_INT_FIELD_GIFT_SEND_COUNT_START = 694	-- 今日赠送礼物次数开始
FACTION_INT_FIELD_GIFT_SEND_COUNT_END = 744	-- 今日赠送礼物次数结束
