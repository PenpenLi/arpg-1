...
PLAYER_FIELD_FLAGS = 270	-- 主玩家下标flags
PLAYER_FIELD_FLAGS_END = 278	-- 预留8个32位flags
PLAYER_FIELD_ONLINE_TIME = 278	-- 总在线时长(分钟为单位)
PLAYER_FIELD_ANGER = 279	-- 怒气改变
PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD = 280	-- 跳跃CD
